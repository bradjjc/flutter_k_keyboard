...
class _CustomKeyBoardState extends State<CustomKeyBoard> {
  ...
  String makeHan() {
    ...
    int makeResult =
        0xAC00 + (28 * 21 * (choIndex)) + (28 * (junIndex)) + jonIndex;
  ...
  commit(String hanGle) {
    if (!chos.contains(hanGle.codeUnitAt(0)) &&
        !juns.contains(hanGle.codeUnitAt(0)) &&
        !jons.contains(hanGle.codeUnitAt(0))) {
      setState(() {
        directlyCommit();
  ...
  bool junAvailable() {
    if (jun == 'ㅙ'.codeUnitAt(0).toString() ||
        jun == 'ㅞ'.codeUnitAt(0).toString() ||
        jun == 'ㅢ'.codeUnitAt(0).toString() ||
        jun == 'ㅐ'.codeUnitAt(0).toString() ||
        jun == 'ㅔ'.codeUnitAt(0).toString() ||
        jun == 'ㅛ'.codeUnitAt(0).toString() ||
        jun == 'ㅒ'.codeUnitAt(0).toString() ||
        jun == 'ㅖ'.codeUnitAt(0).toString()) {
      return false;
    }
    return true;
  }
